      ...
      <div className="relative z-10 h-[50vh] flex items-center ">
        ...
        <div className="container mx-auto px-4 relative z-20">
          ...
          >
            ...
            >
              VespineIT is a leading provider of innovative IT solutions,
      ...
      <section id="who-we-are" className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 w-[85%] mx-auto relative z-10">
          ...
          >
            ...
            >
              Innovators, creators, and problem solvers united by a passion for
                ...
                <div className="relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl p-10 rounded-3xl border border-white/10 overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-gray-300 leading-relaxed text-lg mb-6">
                      Vespine IT was founded in{" "}
                      <span className="text-orange-400 font-semibold">
                        2024
                      </span>{" "}
                      with a vision to empower businesses through innovative
                      technology solutions. Starting as a small team of
                      passionate developers, we are steadily growing and
                      building a strong foundation within Sri Lanka's IT
                      industry.
                    </p>

                    <p className="text-gray-300 leading-relaxed text-lg">
                      Our team is focused on combining technical skills and
                      creative thinking to help local businesses solve
                      real-world problems and prepare for future digital
                      opportunities.
                    </p>
                  </div>
                </div>
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl p-10 rounded-3xl border border-white/10 overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-gray-300 leading-relaxed text-lg mb-6">
                      We believe in building more than just software - we build
                      relationships, trust, and sustainable growth. Every
                      project is an opportunity to create lasting value for our
                      clients and their customers.
                    </p>

                    <p className="text-gray-300 leading-relaxed text-lg">
                      Innovation, integrity, and excellence drive everything we
                      do. We're committed to staying at the forefront of
                      technology while never losing sight of the human element
                      that makes great solutions truly great.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    "Leading-edge solutions built with cutting-edge technologies",
                  color: "orange",
                ...
                },
                {
                  ...
                  title: "Expert Team",
                  description:
                    "Skilled professionals with diverse expertise and proven track records",
                  color: "blue",
                ...
                },
                {
                  ...
                  title: "Global Reach",
                  description:
                    "Serving clients worldwide with localized understanding and support",
                  color: "purple",
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br from-${highlight.color}-500/10 to-${highlight.color}-600/5 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                  ></div>
                  ...
                  <div className="relative bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-xl p-8 rounded-2xl border border-gray-700/50 h-full">
                    ...
                    <div className="mb-6">
                      <div
                        className={`p-4 bg-gradient-to-br from-${highlight.color}-400/20 to-${highlight.color}-600/20 rounded-xl border border-${highlight.color}-400/30 inline-flex`}
                      >
                    ...
                    {/* Content */}
                    <h4
                      className={`text-xl font-bold mb-3 text-white group-hover:bg-gradient-to-r group-hover:${highlight.gradient} group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300`}
                    >
                      {highlight.title}
                    </h4>
                    ...
                    {/* Bottom accent */}
                    <div
                      className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-${highlight.color}-500/50 to-transparent transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500`}
                    ></div>
                  </div>
                </motion.div>
              ))}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.p
              ...
              className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed"
            >
              The driving forces behind everything we do - our commitment to
              innovation and our vision for the future
            </motion.p>
          </motion.div>
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl p-10 rounded-3xl border border-white/10 overflow-hidden">
                ...
                <p className="text-gray-300 leading-relaxed text-lg mb-8">
                  ...
                  aim to be the catalyst that transforms challenges into
                  opportunities through thoughtful application of technology.
                </p>
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl p-10 rounded-3xl border border-white/10 overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-5">
                  ...
                  >
                    <defs>
                      ...
                      >
                        <polygon
                          points="12.5,2 22,10 12.5,18 3,10"
                          fill="currentColor"
                        />
                      </pattern>
                    </defs>
                ...
                <div className="flex items-center justify-between mb-8">
                  ...
                  <div className="text-right">
                    <div className="text-sm text-blue-400 font-semibold uppercase tracking-wider">
                      Our Future
                    </div>
                  </div>
                </div>
                ...
                <p className="text-gray-300 leading-relaxed text-lg mb-8">
                  ...
                  for our ability to envision and implement solutions that not
                  only address current challenges but anticipate future
                  opportunities in the ever-evolving technology landscape.
                </p>
      ...
      <section className="py-20 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 w-[90%] mx-auto">
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-xl p-8 rounded-2xl border border-gray-700/50 overflow-hidden h-full">
                  ...
                  <blockquote className="text-gray-200 text-lg leading-relaxed mb-8 italic relative">
                    <span className="text-orange-400 text-4xl absolute -top-2 -left-1 font-serif">
                      "
                    </span>
                    <span className="pl-8">{testimonial.quote}</span>
                    <span className="text-orange-400 text-4xl absolute -bottom-6 right-0 font-serif">
                      "
                    </span>
                  </blockquote>
          ...
          <motion.div
            ...
            className="mt-20 border-t border-gray-700/50"
          >
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-center"></div>
          </motion.div>
